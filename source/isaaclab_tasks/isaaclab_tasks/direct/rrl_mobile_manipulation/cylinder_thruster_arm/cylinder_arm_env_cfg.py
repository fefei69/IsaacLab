...
# Pre-defined configs
##
from isaaclab_assets import CYLINDER_CFG, CYLINDER_WXAI_CFG , RRLM3_CFG  # isort: skip
...
@configclass
class CylinderArmEnvCfg(DirectRLEnvCfg):
    ...
    tiled_camera: TiledCameraCfg = TiledCameraCfg(
        prim_path="/World/envs/env_.*/Robot/wxai/link_6/camera",
        offset=TiledCameraCfg.OffsetCfg(pos=(0, 0, 0.05), rot=(1, 0.0, 0.0, 0.0), convention="world"),
    ...
    # robot 
    robot: ArticulationCfg = CYLINDER_WXAI_CFG.replace(prim_path="/World/envs/env_.*/Robot") # type: ignore
