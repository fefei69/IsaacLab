...
from .cylinder_arm_env_cfg import CylinderArmEnvCfg     # isort: skip
...
class M3Env(DirectRLEnv):
    ...
    cfg: CylinderArmEnvCfg
    
    def __init__(self, cfg: CylinderArmEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _apply_action(self):
        ...
        body_ids = self.robot.find_bodies("Cylinder")[0] # Cylinder, alpha3_v4_part_glb
