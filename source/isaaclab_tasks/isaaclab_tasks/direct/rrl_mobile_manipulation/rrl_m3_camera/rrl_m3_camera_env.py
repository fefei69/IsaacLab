...
from .rrl_m3_camera_env_cfg import M3CameraEnvCfg  # isort: skip


class M3CameraEnv(DirectRLEnv):
    ...
    def __init__(self, cfg: M3CameraEnvCfg, render_mode: str | None = None, **kwargs):
